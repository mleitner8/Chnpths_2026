...
#define gCa_Ltypebar_columnindex 0
#define hTauFac _p[1]
#define hTauFac_columnindex 1
#define ica _p[2]
#define ica_columnindex 2
#define gCa_Ltype _p[3]
#define gCa_Ltype_columnindex 3
#define m _p[4]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Ca_Ltype /ddn/mleitner8/Chnpths_2026/cells/Neuron_Model_12HH16HH/mechanisms/Ca_Ltype.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ddn/mleitner8/Chnpths_2026/cells/Neuron_Model_12HH16HH/mechanisms/Ca_Ltype.mod";
static const char* nmodl_file_text = 
