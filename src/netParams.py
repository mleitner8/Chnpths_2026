...
cellParamLabels = ['IT2_reduced', 'IT4_reduced', 'IT5A_reduced', 'IT5B_reduced',
                   ...
                   'IT5A_full', 'PT5B_reduced'] #, 'PT5B_full'] # 'NGF_simple', 'VIP_reduced'] # list of cell rules to load from file
...
inhTypes = ['PV_simple', 'SOM_simple']
excTypes = ['IT2_reduced', 'IT4_reduced', 'IT5A_reduced', 'IT5B_reduced', 'IT6_reduced', 'CT6_reduced', 'IT5A_full', 'PT5B_full', 'PT5B_reduced']
            # ------------------------------------------------------------------------------
...
if 'PT5B_full' not in loadCellParams:
    ...
    variants = csv_to_dict('../cells/MutantParameters_updated_042226.csv')
    ...
    netParams.addCellParamsWeightNorm('PT5B_full', '../conn/PT5B_full_weightNorm_TIM.pkl',
    ...
    if saveCellParams: netParams.saveCellParamsRule(label='PT5B_full', fileName='../cells/Na12HH16HH_TF_Feb2026.json')
...
netParams.synMechParams['GABAB'] = {'mod': 'MyExp2SynBB', 'tau1': 3.5, 'tau2': 260.9, 'e': -93} #original -93 (-85)
netParams.synMechParams['GABAA'] = {'mod': 'MyExp2SynBB', 'tau1': 0.07, 'tau2': 18.2, 'e': -80} #original -80 (-70)
netParams.synMechParams['GABAASlow'] = {'mod': 'MyExp2SynBB', 'tau1': 2, 'tau2': 100, 'e': -80} #original -80 (-70)
